 ...
 *
 * BOTH CTAs stay in the header — "Submit CV" and "Request Staff" — so the
 * job-seeker and employer paths are equally one click away from anywhere on
 * the site, not just from the page body.
 */
